// src/components/TrainingForm/TrainingForm.js
import React, { useState } from 'react';
import axios from 'axios';
import { Form, Button, Alert } from 'react-bootstrap';
import './TrainingForm.css';

const TrainingForm = ({ onTrainingStatus }) => {
  ...
  return (
    <div className="training-form">
      <h2>Upload Additional Training Data</h2>
      <Form onSubmit={handleTrainingSubmit}>
        <Form.Group controlId="formTrainingFile">
          ...
          <Form.Control type="file" onChange={handleTrainingFileChange} />
        </Form.Group>
